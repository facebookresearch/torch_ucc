...
with profiler.profile(args.enable_prof, args.use_cuda) as prof:
  for count in counts:
      np.random.seed(3131)
...
if args.enable_prof:
  prof_dir = "{}/prof".format(os.path.dirname(os.path.abspath(__file__)))
  trace_file = "{}/alltoallv_{}.json".format(prof_dir, comm_rank)
